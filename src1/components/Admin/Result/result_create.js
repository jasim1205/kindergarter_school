                ...
                <div className="col-12">
                  <table className="table table-hover table-bordered">
                    <thead className="bg-dark text-white">
                      <tr>
                        <th>Student</th>
                        <th>Subjective_Marks</th>
                        <th>Objective_Marks</th>
                        ...
                        students.map((student) => (
                          <tr key={student.id}>
                            ...
                            <td>
                              <input
                                value={
                                  inputs[student.id]?.subjective_marks || ""
                                }
                            ...
                            <td>
                              <input
                                value={
                                  inputs[student.id]?.objective_marks || ""
                                }
                                onChange={(e) => handleChange(e, student.id)}
                                type="number"
                                className=""
                            ...
                            <td>
                              <input
                                value={inputs[student.id]?.practical || ""}
                                onChange={(e) => handleChange(e, student.id)}
                                type="number"
                                className=""
                                name="practical"
                            ...
                            <td>
                              <input
                                value={inputs[student.id]?.total_marks || ""}
                                onChange={(e) => handleChange(e, student.id)}
                                type="number"
                                className=""
                                name="total_marks"
